        ...
        <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/20 p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              {showEmailHint && (
                <p className="text-xs text-error mt-1.5">
                  Please use Latin characters — switch your keyboard layout to English.
                </p>
              )}
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary text-on-primary py-2.5 rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
