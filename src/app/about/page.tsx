...
const DESCRIPTION =
  'Τι είναι το NextService, πώς λειτουργεί το marketplace συνεργείων αυτοκινήτου, πώς ελέγχονται τα συνεργεία και γιατί η υπηρεσία είναι δωρεάν για τους πελάτες.'
        ...
        <div className="max-w-3xl mx-auto px-5 md:px-8 pt-8">
          ...
          <header className="mb-10">
            ...
            <p className="mt-4 text-base text-secondary leading-relaxed">
              Το NextService είναι marketplace συνεργείων αυτοκινήτου για την ελληνική
              αγορά. Συνδέει ιδιοκτήτες οχημάτων με επαγγελματικά συνεργεία, ώστε η επιλογή
              να γίνεται με ανοιχτή σύγκριση τιμής, διαθεσιμότητας και ανταλλακτικών — και
              όχι με τηλέφωνα στην τύχη.
            </p>
          </header>
