        ...
        {...jsonLdScript(
          graphJsonLd([
            ...
            breadcrumbJsonLd([
              ...
              { name: 'Πολιτική Απορρήτου', url: `${SITE_URL}/privacy/` },
            ]),
          ])
        )}
      />
        ...
        <section className="space-y-6 text-sm leading-relaxed text-on-surface">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>Διαγραφή:</strong> Να ζητήσετε διαγραφή του λογαριασμού σας και των δεδομένων σας (&laquo;δικαίωμα στη λήθη&raquo;). Αυτό μπορείτε να το κάνετε άμεσα από το προφίλ σας.</li>
